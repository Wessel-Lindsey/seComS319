...
const items = [
  ...
  {
    src: require("assets/soundClips/Commercial_Demo.mp3"),
    altText: "Commercial",
    caption: "Commercial"
  },
  {
    src: require("assets/soundClips/eLearning_Training_Demo.mp3"),
    altText: "eLearning",
    caption: "eLearning"
  },
  {
    src: require("assets/soundClips/Self_Development_Demo.mp3"),
    altText: "Self-Development",
    caption: "Self-Development"
  },
  {
    src: require("assets/soundClips/Telephone_and_IVR_Demo.mp3"),
    altText: "Telephone and IVR",
    caption: "Telephone and IVR"
  },
  {
    src: require("assets/soundClips/Video_Game_Demo.mp3"),
    altText: "Video Game",
    caption: "Video Game"
  }
];
